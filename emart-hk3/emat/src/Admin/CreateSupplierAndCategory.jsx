...
//                 setCategory(prevState => ({ ...prevState, supplierId: res.data._id }));
//             })
...
//     return (
//         <div>
//             <h1>Create Supplier and Category</h1>
//             <div>
//                 <h2>Create Supplier</h2>
//                 <input type="text" name="name" value={supplier.name} onChange={handleSupplierChange} placeholder="Supplier Name" />
//                 <input type="text" name="address" value={supplier.address} onChange={handleSupplierChange} placeholder="Address" />
//                 <input type="text" name="phone" value={supplier.phone} onChange={handleSupplierChange} placeholder="Phone" />
//                 <button onClick={createSupplier}>Create Supplier</button>
//             </div>
//             <div>
//                 <h2>Create Category</h2>
//                 <input type="text" name="name" value={category.name} onChange={handleCategoryChange} placeholder="Category Name" />
